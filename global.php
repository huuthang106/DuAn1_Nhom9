...
function thanh_toan()
{
    ...
    // if ($httpCode == 200) {
    //     $dell_cart = new carts();
    //     $dell = $dell_cart->dell_cart_user_id($_SESSION['user_id']);
    //     // Tiếp tục với các hàm xử lý tiếp theo
    // } else {
    ...
    $key= $get_total_bill->get_total_bill($item_bill);

    $vnp_Amount = $key['total'] * 100;
