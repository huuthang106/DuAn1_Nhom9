                        ...
                        ?>
                            ...
                            <form action="index.php?act=update_categories&category_id=<?= $category_id ?>" method="post">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <div class="input-group"> <input readonly class="form-control" type="text" name="category_id" value="<?= $category_id ?>" placeholder=""> </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <div class="input-group"> <input class="form-control" type="text" name="name" value="<?= $name ?>" placeholder=""> </div>
                                        </div>
                                    </div>
                                </div>
