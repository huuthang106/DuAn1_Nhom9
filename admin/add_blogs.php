                    ...
                    <div class="card-body">
                        ...
                        <form action="index.php?act=add_blogs" method="post">
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <input class="form-control" type="text" name="title" value="<?php echo $_POST['title'] ?? ''; ?>" placeholder="">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <div class="input-group"> <textarea style="height: 200px" class="form-control" type="text" name="content" value="<?php echo $_POST['content'] ?? ''; ?>" placeholder=""></textarea> </div>
                                    </div>
                                </div>
                            </div>
