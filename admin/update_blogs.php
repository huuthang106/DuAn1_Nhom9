                        ...
                        ?>
                            ...
                            <form action="index.php?act=update_blogs&blog_id=<?= $blog_id ?>" method="post">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <div class="input-group"> <input readonly class="form-control" type="text" name="blog_id" value="<?= $blog_id ?>" placeholder=""> </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <div class="input-group"> <input class="form-control" type="text" name="title" value="<?= $title ?>" placeholder=""> </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <div class="input-group"> <textarea style="height: 200px" class="form-control" type="text" name="content" value="" placeholder=""><?php echo $content; ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <div class="input-group"> <input class="form-control" type="text" name="day" value="<?= $day ?>" placeholder="DD/MM/YYYY"> </div>
                                        </div>
                                    </div>
                                </div>

                                <div class=" d-flex flex-column text-center px-5 mt-3 mb-3"> </div> <button type="submit" class="btn btn-primary btn-block confirm-button">Cập nhật</button>
                            </form>
